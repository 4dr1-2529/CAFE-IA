...
export default function Arquitectura() {
  const capas = [
    ...
    },
    {
      ...
      componentes: ['src/services/api.js', 'getLotes()', 'createLote()', 'createControlCalidad()', 'ejecutarPrediccionIA()']
    },
    {
      nombre: 'DOMINIO',
      color: 'bg-green-500',
...
└── index.html`}
      ...
      <div className="bg-cafeVerde-50 border border-cafeVerde-200 rounded-xl p-6">
        ...
        <p className="text-sm text-cafeVerde-700 mb-4">Cada módulo de UI consume endpoints en `src/services/api.js`, que llegan a rutas Express y finalmente se guardan en SQLite.</p>
