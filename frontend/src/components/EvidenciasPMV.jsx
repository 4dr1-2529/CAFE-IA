  ...
  const evidencias = [
    ...
    },
    {
      ...
      items: [
        ...
        'frontend/src/infrastructure - Servicios IA por reglas',
        'backend/routes - API REST Express',
        'backend/database.sqlite - Persistencia SQLite'
      ]
    },
    {
      ...
      <div className="bg-white rounded-xl shadow-sm border border-cafe-100 p-6">
        ...
        <div className="space-y-4">
          <div className="bg-gray-900 rounded-lg p-4">
            ...
            <code className="text-green-400 font-mono text-sm block mt-1">cd frontend && npm install</code>
          </div>
          
          <div className="bg-gray-900 rounded-lg p-4">
            <p className="text-gray-400 text-sm mb-2"># Iniciar servidor de desarrollo</p>
            <code className="text-green-400 font-mono text-sm">cd frontend && npm run dev</code>
          </div>
