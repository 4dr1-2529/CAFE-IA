...
import { Package, TrendingUp, Award, Activity, Brain, Droplets, Thermometer } from 'lucide-react'
  ...
  return (
    <div className="space-y-6 animate-fadeIn">
      ...
      <div className="bg-gradient-to-r from-cafe-800 to-cafeVerde-700 rounded-2xl p-6 text-white">
        ...
        <p className="text-cafe-100">Sistema de trazabilidad, control de calidad y reportes del café sostenible.</p>
